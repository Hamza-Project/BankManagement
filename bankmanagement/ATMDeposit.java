...
public class ATMDeposit {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ATMDeposit window = new ATMDeposit();
	...
	private void initialize() {
		...
		btnBack.setBounds(244, 158, 128, 35);
